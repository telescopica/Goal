...
public class TestClassName extends IPersistable implements IParsingContext, IServerSideIdable {
    protected int mTestAttribute;
    protected String mTestAttribute2;
    protected static String OWNED_RELATIONSHIP_TEST_RELATIONSHIP = "TestRelationship";
    protected static String OWNED_RELATIONSHIP_TEST_RELATIONSHIP2 = "TestRelationship2";
    protected static String OWNED_RELATIONSHIP_TEST_RELATIONSHIP3 = "TestRelationship3";
    public static String TAG_NAME = "TestClassName";
    protected int mId;
    ...
    */
    public TestClassName() {
        super();
        getOneToOneMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP,TestClassName2.class);
        getOneToManyMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP2,TestClassName2.class);
        getOneToManyMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP3,TestClassName2.class);
    }
    /**
    * value constructor
    ...
    */
    public TestClassName(int testAttribute, String testAttribute2){
        super();
        getOneToOneMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP,TestClassName2.class);
        getOneToManyMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP2,TestClassName2.class);
        getOneToManyMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP3,TestClassName2.class);
    ...
    */
    ...
    /**
    * @return value for TestRelationship property
    */
    public TestClassName2 getTestRelationship(){
        return (TestClassName2)getOneToOneMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP).getTarget();
    }
    /**
    * @param TestRelationship new value for TestRelationship property
    */
    public void setTestRelationship(TestClassName2 TestRelationship){
        getOneToOneMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP).setTarget(TestRelationship);
    }
    /**
    * @return value for TestRelationship2 property
    */
    public Vector getTestRelationship2(){
        return getOneToManyMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP2);
    }
    /**
    * @param newElements new value for TestRelationship2 property
    */
    public void setTestRelationship2(Vector newElements){
        getOneToManyMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP2).replaceContents(newElements);
    }
    /**
    * @return value for TestRelationship3 property
    */
    public Vector getTestRelationship3(){
        return getOneToManyMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP3);
    }
    /**
    * @param newElements new value for TestRelationship3 property
    */
    public void setTestRelationship3(Vector newElements){
        getOneToManyMappingFor(OWNED_RELATIONSHIP_TEST_RELATIONSHIP3).replaceContents(newElements);
    }
    /**
    ...
    */
    public String getRecordStoreName() {
        ...
        return "TestClassName".substring(1,5);
    }
    /**
